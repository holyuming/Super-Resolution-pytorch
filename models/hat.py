...
class ChannelAttention(nn.Module):
    ...
    def __init__(self, num_feat, squeeze_factor=16):
        ...
        hidden_feat = num_feat // squeeze_factor
        if hidden_feat == 0:
            hidden_feat = 1
            
        self.attention = nn.Sequential(
            nn.AdaptiveAvgPool2d(1),
            nn.Conv2d(num_feat, hidden_feat, 1, padding=0),
            nn.ReLU(inplace=True),
            nn.Conv2d(hidden_feat, num_feat, 1, padding=0),
            nn.Sigmoid())
...
class CAB(nn.Module):
    ...
    def __init__(self, num_feat, compress_ratio=3, squeeze_factor=30):
        ...
        self.cab = nn.Sequential(
            # in order to save computational cost, below will be removed
...
class HAT(nn.Module):
    ...
    def __init__(self,
        ...
        if resi_connection == '1conv':
            ...
            self.conv = nn.Conv2d(embed_dim, embed_dim, 1, 1, 0)
...
if __name__ == '__main__':
    ...
    model = HAT(
                ...
                num_heads=(3, 3, 3),
                window_size=8,
                # compress_ratio=3, original
                compress_ratio=4,
                squeeze_factor=30,
                # conv_scale=0.01, original
                conv_scale=0.1,
                overlap_ratio=0.5,
                mlp_ratio=2.,
                qkv_bias=True,
    ...
    print(f'Size: {x.shape} --> {out.shape}')